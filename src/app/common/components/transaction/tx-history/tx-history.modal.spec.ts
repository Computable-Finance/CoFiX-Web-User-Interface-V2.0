...
import { TxHistoryModal } from './tx-history.modal';

describe('TxHistoryModal', () => {
  let component: TxHistoryModal;
  let element: HTMLElement;
  let fixture: ComponentFixture<TxHistoryModal>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TxHistoryModal);
