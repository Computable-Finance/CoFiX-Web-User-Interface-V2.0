...
export class Tooltip implements OnDestroy {
   ...
   */
  get canShow(): boolean {
    return this._canShow && this.tipsContent !== '';
  }
  ...
  private _getTooltipPosition() {
    ...
    if (
      positionTop + tooltipNativeElement.offsetHeight + spacing >
      this.platform.height()
    ) {
      positionTop =
        this.platform.height() - tooltipNativeElement.offsetHeight - spacing;
